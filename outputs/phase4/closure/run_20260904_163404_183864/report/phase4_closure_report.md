...
## Combined
Pairs: 8
Mean/min/max inlier ratio: 45.92184788895315 / 24.0 / 100.0%
Mean/min/max RMSE: 6.633425 / 0.0 / 21.406 px
Mean spatial coverage: 68.075%
Geometry PASS/FAIL: 37.5% / 62.5%
VALIDATED/UNCERTAIN/FAILED: 12.5% / 25.0% / 62.5%
Per-pair results:
- pair_s1: level=1x, ratio=100.0, RMSE=0.0, verdict=VALIDATED.
- pair_s2: level=2x, ratio=56.14035087719298, RMSE=1.1372, verdict=UNCERTAIN.
- pair_s3: level=4x, ratio=47.61904761904761, RMSE=1.5722, verdict=UNCERTAIN.
- pair_s4: level=8x, ratio=34.61538461538461, RMSE=11.3837, verdict=FAILED.
